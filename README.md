...
The most comprehensive Claude Code skill pack for smart home development. **New in v1.6.6:** Volt and Sage gain a **retroactive YAML review** protocol — paste an existing config, get back line-anchored findings with concrete fixes. Plus the legacy "Generated by ha-yaml@…" attribution comments in skill rules update to the post-v1.3 unified plugin name. Builds on v1.6.5's community-component infrastructure. Covers automations, custom integrations, Node-RED flows, dashboards, and full product development from idea to manufacturing.
...
[![Version](https://img.shields.io/badge/Version-v1.6.6-success.svg)](CHANGELOG.md)
...
## 🔄 Already Installed? Update to v1.6.6
